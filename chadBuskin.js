...
module.exports = {
  title: "Chad Buskin", 
  author: "kittenchilly, FlaringK",
  modVersion: 0.1,

  summary: "Replace every text instance of Dave's name with his TRUE one, Chad Buskin.",
  description: "This mod uses FlaringK's Universal subsitutor, the name should be replaced regardless of case or quirk, however it won't replace it in images or flashes",
